...
The runtime was computed for varying number of process' from \(1\) to \(32\) on Leonardo computer. The results were then presented in two histograms, corresponding to the runtime and speedup vs number of processes for three problem size \(108, 2916, 78732\).
